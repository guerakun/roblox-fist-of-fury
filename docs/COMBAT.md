...
### WO-3.2 persistent survival and channel revive (source WIP)
...
Pure Survival39 cases and ReviveControl22 request/cancel cases were reported passed before the interruption. The first actual two-client fixture failed at Registered enemy KO; that failed result remains in PROGRESS. The corrected explicit checkpoint/visibility fixture, latest campaign/travel guards and expanded touch-overlap fixture still require root's fresh runtime output at this recording. Full M3 HumanBot, human tier playtests and updated multiplayer lifecycle acceptance remain open.
