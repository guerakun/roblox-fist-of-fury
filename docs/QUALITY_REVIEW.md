...
7. **Environmental interaction.** Destructible tags are metadata, not a complete destruction system. Vending-machine decorative pieces are separate Parts. Acceptance: breaking a prop removes or transforms its full visual assembly consistently for both clients, with bounded debris and no collision remnants.
