...
| WO-2.2 | combat | implemented; aggregate telemetry pending | 2026-09-24: fresh Studio AttackDirectorAI+EnemyAISlots PASS; world finalreview PASS; front/back slots, nonidleHold,2-5tokens, renewal/capshrink/targetdeparture invalidation, bodytell client contract | WO-2.3 archetypes; five-run aggregate M2 telemetry/frustum/human gates remain open |
