...
M0 closed: five baseline clears, mean278.27s,0.80stocks,543damage. M1 original heroes/IP source gate passes; rendered art/owner approval remains open. M2 through2.6 implemented and unit/runtime fixtures pass, but first 4-player/12-enemy crowd behavior FAILED: idle54.59%, only6/24 eligible action-diversity windows passed. CPU mean0.286ms over38 scopes is below1.5ms, with initial population-evidence limitation. Fixing token starvation/unreachable wall slots and collecting stronger diagnostics before M2 acceptance. Director-only seed1101 was292.37s,0stocks,430damage,idle10.58%,flank90.91%,cap0; not final aggregate. M5 hub/admission/return and Studio multiplayer/lifecycle policy tests pass; published travel/live persistence/same-ID reconnect/device gates remain blocked or unverified. M6 checklist/analytics saved; original icon concept pending owner. M3/M4 notstarted, retained in launch plan. Exact next: WO-2.6 crowd rerun plus five HumanBot/frustum runs, then M3. No publish, Dashboard, sales, live DataStore or place settings changed. Owner decisions: candidate hero names/art, test-universe and human/device acceptance.
...
| WO-2.6 | combat + root | implemented; initial crowd behavior failed, correction in test | f94bd81 fixtures/runtime pass; firstcrowd81.63s4players12enemies idle54.585%,flank100%,cap0,6/24diversitywindows; CPU38scopesmean0.285588ms max0.505117ms (initialsampledpopulationlimitation) | correct starvation/wallslot deadlocks; stronger population latch and 10/30/60s diagnostics; five HumanBot/frustum |
