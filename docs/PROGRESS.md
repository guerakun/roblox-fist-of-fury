...
The launch program is in progress on `launch-program`. M0 baseline is closed. M1 original heroes/story/IP source checks are implemented; rendered art and owner approval of Rook Calder, Bo Marlowe and Isla Veyra remain open. M5 hub/party/admission/return source has policy and Studio multiplayer evidence; published travel, live persistence and same-account reconnect remain unverified or blocked by the overnight restrictions.

M2 source is frozen at `9f29012`, and both place artifacts were rebuilt from it. **All five final HumanBot seeds cleared.** Before/after means: **278.27 -> 398.56 seconds**, **0.80 -> 2.80 stocks lost**, **543 -> 830.4 damage**. Pooled idle **16.10% -> 9.58%**; qualified solo flank coverage **45.45% -> 96.43%**; token-cap breaches **0 -> 0**. Final hits: **351 server accepted / 351 audited / 0 outside / 0 invalid viewport**. This is automated campaign evidence, not human acceptance; ordinary-archetype action-diversity coverage is inconclusive. Historical crowd failures remain saved.

M6 has owner checklists, analytics, original icon concept, hub resource fixes and source audits. WorldLifetime is compiled but its body is not yet run; focus/modal cleanup is queued. M3/M4 remain outstanding; M3 contracts and isolated reward/Heat drafts are prepared but not connected to gameplay. Money never buys power; sales remain disabled.

Final frozen crowd: idle 4.77%, cap0, 21/31 complete diversity windows passed (target still FAIL); four stationary clients were spread by knockback, and later camera suppression limits attack opportunities. CPU: 39 complete scopes, mean0.46067ms, valid4players/12enemies with2273checks and0mismatches. Exact next: release M3 source implementation, while root runs the isolated WorldLifetime fixture. Full M2 human/device/diversity acceptance stays explicit while unblocked engineering progresses. No publication, Creator Dashboard, sales, live DataStores or place settings were changed. All notes are indexed in [launch/README](launch/README.md).
...
| WO-6.5 | world + presentation + combat + root | source audits and owner plans recorded; listed fixes pending | ASSET_INPUT_REVIEW,SCENE_SOURCE_REVIEW,MOVEMENT_AUTHORITY_PLAN independentlyreviewed;existingparticleIDsregistered;actualpostVictory3427instances/52unparented(testbot39)/3575422audio bytes;ScriptMemoryflagunavailable,render1cube nonrepresentative;launchREADMEalllinksresolve | afterfreeze fixinputfocus/modalcleanup; SEC03movementproposalandphysical/publishedchecks remain open; WorldLifetimefixturequeued |
| WO-6.6 | world + root | test fixture prepared; runtime queued behind frozen comparison | WorldLifetime.spec sourceindependentlyreviewed;actualStudio requirecompilesfunctionPASS, bodyNOTexecuted;34props/30fragmentcap/cleanup/restore/rebuild/stalecallback checks prepared;IPgate135filesPASS | rootisolatedWaitingStudio~45s afterfivebots; saveactualresult; nofalseworldlifetimeverification |
