...
| WO-2.4 | combat | implemented; runtime verification next | 2026-09-24: worldsourcePASS;selection/runtimefixtures queued; no tuningclaim | root Studio elite tests; then commit and2.5/2.6 |
