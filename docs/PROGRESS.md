...
| WO-2.6 | combat + root | implemented; corrected crowd and five-run acceptance pending | 2026-09-24:camera-safe18geometry/slotfairness/diversity specsPASS;independentworldreviewPASS. Initialcrowd54.59%idle→fairness53.76%stillFAIL. ValidCPU39scopesmean0.26599ms,max0.43663ms,1134populationchecks0mismatch. Solo diagnostic1101Victory422.93s/3stocks/926damage,idle14.29%,flank100%,cap0;81Hitprojections0outside(initialfixture1x1 limitation). Anonymousrawreportspreserved. | rootcorrected-placement crowd thenfixedfiveHumanBot/frustum; M3 after M2 checkpoint |
