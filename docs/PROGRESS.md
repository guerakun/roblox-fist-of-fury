...
All notes are indexed in [launch/README](launch/README.md). Source audits preserve the three input cleanup findings and the proposed movement-authority design. The post-run scene query is recorded with its test-script and rendering limitations; it does not certify device performance.
