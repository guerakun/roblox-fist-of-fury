...
| WO-6.4 | root + presentation | source audit and isolated hardening specs pass; integration pending | SECURITY_REVIEW.md reviewedbyworld; display snapshot cache30participants×100calls=60simulatedreads,slowfailure/inflight/cleanupPASS;invitation1000churn cap32/TTL/accept/departurePASS actualStudio;unknownrequestsrejectearly;authorityuncached | Hub2client regression; SEC03 movement-origin gap retained without reproducedexploit; re-auditM3/M4 |
