...
| Pending M4 launch features | [Client readiness](M4_CLIENT_READINESS.md), [pickup/weapon design](M4_PICKUP_WEAPON_PLAN.md), [authored drop proposal](M4_DROP_CANDIDATE.md), [reward contract proposal](M4_REWARD_CONTRACT.md) |
